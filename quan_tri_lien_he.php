...
?>
                                    <h4 class="box-title">Phản Hồi Của Khách Hàng </h4>
                                </div>
                                <div class="card-body--">
                                        ...
                                        <table class="table ">
                                            <thead>
                                                <tr style="text-align: center;">
                                                    <th class="serial">Id_Khách</th>
                                                    <th>Tên Khách</th>
                                                    <th>Email</th>
                                                    <th style="text-align: center;">Phản Hồi Của Khách Hàng</th>
                                                </tr>
                                            </thead>
                                    <?php 
                                    ...
                                    ?>
                                            <tbody>
                                                <tr style="text-align: center;">
                                                    ...
                                                    <td> <span class="product"><?php echo $row['phan_hoi'] ;?></span> </td>
                                                   </span></td>
